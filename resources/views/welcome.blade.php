...
<head>
  ...
  <title>Portfolio Hainzel Kemal</title>
...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../assets/img/bg_image_1.webp)">
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <b class="fg-theme">Hainzel</b> Kemal</h1>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">Hainzel Kemal</h1>
          <h5 class="fg-theme mb-3">UI/UX & Web Designer</h5>
          <p class="text-muted">I am a student in Universitas Ciputra Makassar. I'm pursuing an IT Degree. I am born and raised in Makassar City. I love listening to music and read.</p>
          <ul class="theme-list">
            <li><b>From:</b> Makassar, Indonesia</li>
            <li><b>Lives In:</b> Makassar, Indonesia</li>
            <li><b>Age:</b> 19</li>
        ...
        <div class="col-md-6">
          <div class="px-lg-3">
            ...
            <div class="progress-wrapper wow fadeInUp">
              ...
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 90%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="90">90%</div>
              </div>
            </div>
            <div class="progress-wrapper wow fadeInUp">
        ...
        <div class="col-md-6 wow fadeInRight">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              ...
              <div class="details">
                <h5>College</h5>
                <small class="fg-theme">Universitas Ciputra Makassar</small>
                <p>Started college in 2023</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5>High School</h5>
                <small class="fg-theme">SMA Zion Makassar</small>
                <p>Started high school in 2020 and ended in 2023</p>
              </div>
            </li>
          </ul>
        </div>
        <div class="col-md-6 wow fadeInRight" data-wow-delay="200ms">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              <div class="title">2023 - Current</div>
              <div class="details">
                <h5>Junior Code Developer</h5>
                <small class="fg-theme">Universitas Ciputra Makassar</small>
                <p>I am trained in Python, HTML, CSS, JS ,Java, Dart, and PHP during my 1 year in college.</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>I can do basic web design but nothing too fancy.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              <h4 class="fg-theme">AI Development</h4>
              <p>I have made two AI using YoLo v10 and using Tensorflow.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>I've had my fair share of making UI/UX for my web and application mockup</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>I have made a few projects making a web that can handle a form.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="footer-info">
            ...
            <hr class="divider">
            <p class="fs-large fg-white">Universitas Ciputra Makassar, Makassar City, Indonesia</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 py-3">
          <div class="float-lg-right">
            ...
            <ul class="list-unstyled">
              <li><a href="https://www.instagram.com/hain.zel">Instagram</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 py-3">
